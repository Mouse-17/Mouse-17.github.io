<template>
  <main>
    <section class="banner">
      <img alt="" class="imgban" src="../../public/img/Banner1.png">
    </section>

    <!-- Menu thể thao -->
    <div class="box">
      <div class="menu-news">
        <a class="menu-item" href="#">Bóng Đá</a>
        <a class="menu-item" href="#">Bóng Chuyền</a>
        <a class="menu-item" href="#">Cầu Lông</a>
        <a class="menu-item" href="#">Pickleball</a>
        <a class="menu-item" href="#">Tennis</a>
        <a class="menu-item" href="#">Bơi Lội</a>
        <a class="menu-item" href="#">E-Sports</a>
        <a class="menu-item" href="#">Bóng đá quốc tế</a>
        <a class="menu-item" href="#">Bóng đá Việt Nam</a>
        <a class="menu-item" href="#">Golf</a>
        <a class="menu-item" href="#">Xem thêm</a>
      </div>
    </div>
      ...
      <div class="content main-content">
        ...
        <div class="left-content">
          ...
          <div class="featured-news">
            <img alt="Hình ảnh thể thao" class="feature-image" src="../../public/img/Picture1.png">
            <div class="news-text">
              ...
              <p class="news-description">Danh thủ Dương Hồng Sơn nhận xét thẳng thắn về màn trình diễn của thủ môn
                Filip Nguyễn ở trận CLB CAHN hòa Hà Tĩnh tại vòng 12 V-League 2024/25</p>
              <div class="news-meta">
          ...
          <div class="news-grid">
            <div class="news-item">
              <img alt="Ronaldo" src="../../public/img/Picture2.png">
            ...
            <div class="news-item">
              <img alt="Hoa Khôi bóng chuyền VN" src="../../public/img/Picture3.png">
              <div class="news-content">
            ...
            <div class="news-item">
              <img alt="Thùy Linh" src="../../public/img/Picture4.png">
              <div class="news-content">
            ...
            <div class="news-item">
              <img alt="T1 và Gumayusi" src="../../public/img/Picture5.png">
              <div class="news-content">
            ...
            <div class="news-item">
              <img alt="Cầu lông thay đổi luật" src="../../public/img/Picture6.png">
              <div class="news-content">
                <span class="news-category small">Cầu lông</span>
            ...
            <div class="news-item">
              <img alt="Chọn vợt cầu lông" src="../../public/img/Picture7.png">
              <div class="news-content">
        ...
        <div class="right-sidebar">
          ...
          <div class="sidebar-widget">
            ...
            <div v-if="showSettings" class="rankings-settings">
              ...
              <div class="settings-options">
                <label>
                  <input v-model="showStats" type="checkbox"> Hiện thống kê
                </label>
                <label>
                  <input v-model="showForm" type="checkbox"> Hiện phong độ
                </label>
            ...
            <div v-else class="no-data">
              ...
              <button class="refresh-btn" @click="fetchRankings">
          ...
          <div class="sidebar-widget">
            ...
            <div class="ads-container">
              <img alt="Quảng cáo 1" src="../../public/img/Picture11.png">
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="box video-section">
      <div class="video-header">
        <div class="header-content">
          ...
          <a class="view-all-link" href="/videos">
        ...
        <div class="video-row">
          <div class="video-item">
            <div class="video-thumbnail">
              <img alt="Video highlight" src="../../public/img/Picture1.png">
          ...
          <div class="video-item">
            <div class="video-thumbnail">
              <img alt="Video highlight" src="../../public/img/Picture5.png">
              <div class="play-button">
                <i class="bi bi-play-circle-fill"></i>
              </div>
          ...
          <div class="video-item">
            <div class="video-thumbnail">
              <img alt="Video highlight" src="../../public/img/Picture3.png">
              <div class="play-button">
                <i class="bi bi-play-circle-fill"></i>
              </div>
          ...
          <div class="video-item">
            <div class="video-thumbnail">
              <img alt="Video highlight" src="../../public/img/Picture7.png">
              <div class="play-button">
                <i class="bi bi-play-circle-fill"></i>
              </div>
        ...
        <div class="news-row">
          <div class="news-item">
            <div class="news-thumbnail">
              <img alt="Nguyễn Thùy Linh" src="../../public/img/Picture8.png">
          ...
          <div class="news-item">
            <div class="news-thumbnail">
              <img alt="Asian Cup" src="../../public/img/Picture9.png">
              <div class="news-overlay"></div>
            </div>
            <div class="news-info">
          ...
          <div class="news-item">
            <div class="news-thumbnail">
              <img alt="Lịch thi đấu tennis" src="../../public/img/Picture10.png">
              <div class="news-overlay"></div>
            </div>
            <div class="news-info">
          ...
          <div class="news-item">
            <div class="news-thumbnail">
              <img alt="VĐV bơi lội" src="../../public/img/Picture5.png">
              <div class="news-overlay"></div>
            </div>
            <div class="news-info">
